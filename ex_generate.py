from quizgen.generator import *

# load students list
students = Student('./example/student.xlsx')
...
for student_id, student_name in students:
    ...
    # question 2
    text2 = Text('2.(10 คะแนน) จงแก้สมการต่อไปนี้')
    question2 = [text2]
    ...
    figure3 = Figure('./example/figures', width=4)  # 4 inches width
    ...
    Quiz(student_id, student_name,
         ...
         [solution1,
          solution2,
          solution3],
         question_path='./example/exam1',
         solution_path='./example/sol1'
         )
